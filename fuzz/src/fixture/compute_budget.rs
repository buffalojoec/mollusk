...
use {super::proto, solana_program_runtime::compute_budget::ComputeBudget};
...
impl From<proto::ComputeBudget> for ComputeBudget {
    fn from(input: proto::ComputeBudget) -> Self {
        ...
        let max_invoke_stack_height = max_invoke_stack_height as usize;
...
impl From<&ComputeBudget> for proto::ComputeBudget {
    fn from(input: &ComputeBudget) -> Self {
        ...
        proto::ComputeBudget {
            ...
            max_invoke_stack_height: *max_invoke_stack_height as u64,
